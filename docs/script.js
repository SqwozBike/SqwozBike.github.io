var themes = [
    ...
    ['гиппопотомонстросескипедалофобия','Боязнь длинных слов.'], //66
    ['трипофобия','Боязнь дырок.'], //67
    ['ономатопея','Лингвистическое явление, когда слово или фраза звучит подобно или имитирует звук, который оно описывает или связан с ним (пример "бум").'], //68
    ['капибара','Крупный грызун, являющийся самым крупным ныне живущим грызуном в мире'], //69
    ['ксилофон','Музыкальный инструмент, состоящий из набора деревянных или металлических пластин (пластинок), расположенных в порядке возрастания или убывания высоты звука. Его пластины закреплены на раме или подвешены на подставке и обычно располагаются в порядке соответствующем музыкальной гамме.'], //70
    ['медикаменты','Если жена медик, а муж мент, то дети...'], // 71
    ['нерпа','Единтсвенное млекопитающее, которое обитает в водах озера Байкал.'], //72
];
